...
$old = $di->get('customer')->getCustomerDetailsById($id);
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                                    ...
                                    <div class="col-md-12">
                                        <form action="<?= BASEURL; ?>helper/routing.php" method="POST" id="edit-customer">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <button type="submit" class="btn btn-primary" name="edit_customer" value="editCustomer"><i class="fa fa-bookmark"></i> Save Changes</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
            ...
            <!-- PAGE LEVEL SCRIPTS -->
            <?php
            require_once(__DIR__ . "/../includes/page-level/customer/edit-customer-scripts.php");
            ?>
