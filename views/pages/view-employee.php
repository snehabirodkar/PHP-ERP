...
if (isset($_GET['id']) && $_GET['id'] != '' && $di->get('database')->exists('employees', ["id" => $_GET['id']])) {
  $id = $_GET['id'];
} else {
  Util::redirect("404.html");
}

$data = $di->get('employee')->getEmployeeDetailsById($id);
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Basic Card Example -->
          <form action="<?= BASEPAGES; ?>edit-employee.php?id=<?= $id ?>" method="POST" id="view-employee">
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <div class="row">
                  <div class="col-md-6">
                    <h6 class="mt-2 font-weight-bold text-primary">View Employee</h6>
                  </div>

                  <div class="col-md-6 text-right">
                    <button type="submit" class="btn btn-primary" name="edit_employee" value="editEmployee"><i class="fa fa-pencil-alt"></i> Edit</button>
                    <button type="button" class="btn btn-danger" name="delete_employee" value="deleteEmployee" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash"></i> Delete</button>
                  </div>
                </div>
              </div>
              <div class="card-body">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-md-9">
                                <select readonly name="gender" class="form-control <?= $errors != '' && $errors->has('gender') ? 'error' : ''; ?>">
                                  <option value="Male" <?= $data != '' && isset($data['gender']) == "Male" ? 'selected' : '' ?>>Male</option>
                                  <option value="Female" <?= $data != '' && isset($data['gender']) == "Female" ? 'selected' : '' ?>>Female</option>
                                </select>
                              </div>
                            </div>
                          </div>
