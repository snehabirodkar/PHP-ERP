...
$pageTitle = "Easy ERP | Edit Employee";
...
$old = $di->get('employee')->getEmployeeDetailsById($id);
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="gender" class="form-control <?= $errors != '' && $errors->has('gender') ? 'error' : ''; ?>">
                                                            <option value="Male" <?= $old != '' && isset($old['gender']) == "Male" ? 'selected' : '' ?>>Male</option>
                                                            <option value="Female" <?= $old != '' && isset($old['gender']) == "Female" ? 'selected' : '' ?>>Female</option>
                                                        </select>
                                                        <?php
                                                ...
                                                <div class="col-md-12">
                                                    <button type="submit" class="btn btn-primary" name="edit_employee" value="editEmployee"><i class="fa fa-bookmark"></i> Save Changes</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
            ...
            <!-- PAGE LEVEL SCRIPTS -->
            <?php
            require_once(__DIR__ . "/../includes/page-level/employee/edit-employee-scripts.php");
            ?>
