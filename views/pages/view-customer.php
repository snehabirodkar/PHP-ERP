...
if (isset($_GET['id']) && $_GET['id'] != '' && $di->get('database')->exists('customers', ["id" => $_GET['id']])) {
  $id = $_GET['id'];
} else {
  Util::redirect("404.html");
}

$data = $di->get('customer')->getCustomerDetailsById($id);
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Basic Card Example -->
          <form action="<?= BASEPAGES; ?>edit-customer.php?id=<?= $id ?>" method="POST" id="view-customer">
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <div class="row">
                  <div class="col-md-6">
                    <h6 class="mt-2 font-weight-bold text-primary">View Customer</h6>
                  </div>

                  <div class="col-md-6 text-right">
                    <button type="submit" class="btn btn-primary" name="edit_customer" value="editCustomer"><i class="fa fa-pencil-alt"></i> Edit</button>
                    <button type="button" class="btn btn-danger" name="delete_customer" value="deleteCustomer" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash"></i> Delete</button>
                  </div>
                </div>
              </div>
              <div class="card-body">
