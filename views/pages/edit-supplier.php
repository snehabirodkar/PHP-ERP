...
$old = $di->get('supplier')->getSupplierDetailsById($id);
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="company_name" class="form-control <?= $errors != '' && $errors->has("company_name") ? 'error' : '' ?>" placeholder="Enter First Name" value="<?= $old != '' && isset($old["company_name"]) ? $old["company_name"] : ''; ?>" />
                                                        <?php
                                                ...
                                                <div class="col-md-12">
                                                    <button type="submit" class="btn btn-primary" name="edit_supplier" value="editSupplier"><i class="fa fa-bookmark"></i> Save Changes</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
            ...
            <!-- PAGE LEVEL SCRIPTS -->
            <?php
            require_once(__DIR__ . "/../includes/page-level/supplier/edit-supplier-scripts.php");
            ?>
